...
| [RelayGo](https://github.com/abcxyz-123456/RelayGo) | - | GPL-3.0 | 联合封禁、管理面板 |
| [telegram-verify-bot](https://github.com/Squarelan/telegram-verify-bot) | Squarelan | GPL-3.0 | 白名单、欺诈检测 |
| [telegram_private_chatbot](https://github.com/jikssha/telegram_private_chatbot) | jikssha | MIT | 部署流程参考 |
